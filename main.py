...
def play():
    ...
    vars.set(playlist.get(tkr.ACTIVE))
...
Button2 = tkr.Button(music_player, width=5, height=3,
                     ...
                     command=stop, bg="navy", fg="gold")
Button3 = tkr.Button(music_player, width=5, height=3,
                     font="Verdana 12 bold ", text="PAUSE",
                     command=pause, bg="navy", fg="gold")
Button4 = tkr.Button(music_player, width=5, height=3,
                     font="Verdana 12 bold ", text="UNPAUSE",
                     command=unpause, bg="navy", fg="gold")

vars = tkr.StringVar()
song_title = tkr.Label(music_player, font="Verdana 12 bold", textvariable=vars)
